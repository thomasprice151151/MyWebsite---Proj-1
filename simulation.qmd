...
description: |
 ...
 This study will use the slope of this comparison as the test statistic. The slope in this case measures, direction of association. Meaning if the slope is positive that should entail higher life expectancy and higher GDP. The steeper the slope, the stronger the link. 
 Under the null hypothesis, when life expectancy variables are shuffled randomly among countries, the slope should average around zero.
  If the observed slope is far from this null distribution, the relationship is unlikely due to chance.
